...
@section('subtitle', 'Tambah mata kuliah baru')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Contoh: MTK-001, MTK 002 .."
                           required>
                    @error('kode_materi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Kode unik untuk mata kuliah (huruf dan angka)</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                           placeholder="Contoh: Kebijakan Publik, dll .."
                           required>
                    @error('nama_materi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Nama lengkap mata kuliah</p>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div class="text-sm text-blue-700">
                        <div id="preview-kode" class="mb-1">Kode: <span class="font-mono">-</span></div>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="text-sm text-yellow-700 mt-1 list-disc list-inside space-y-1">
                    <li>Pastikan kode mata kuliah unik dan mudah diingat</li>
                    <li>Gunakan nama yang jelas dan deskriptif</li>
                    <li>Setelah membuat mata kuliah, Anda bisa menambahkan jadwal sesi</li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const kodeInput = document.getElementById('kode_materi');
        ...
        function updatePreview() {
            ...
            previewKode.innerHTML = `Kode: <span class="font-mono bg-blue-100 px-1 rounded">${kode}</span>`;
